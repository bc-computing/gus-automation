...
def generate_cdf_gnuplot_script(plot_script_file, plot_target_directory, csvs, protocols):
    with open(plot_script_file, 'w+') as f:
        ...
        # width 1150 for small
        # width 2050 for large
        f.write("set terminal pngcairo size 2050,500 enhanced font 'Helvetica,36'\n")
        ...
        f.write('set style line 3 linecolor "orange-red" pointtype 11 linewidth 6\n')
        f.write('set style line 2 linecolor "blue" pointtype 4 linewidth 6 dashtype 2\n')
